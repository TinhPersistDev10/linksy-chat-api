...
namespace linksy_backend_api.Infrastructure.Migrations
{
    ...
    [Migration("20260819150102_AddChatroomQuickEmoji")]
    partial class AddChatroomQuickEmoji
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("linksy_backend_api.Domain.Entities.Models.ContentModerationSetting", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("content_moderation_settings_pkey");

                    b.ToTable("content_moderation_settings", (string)null);
                });

            modelBuilder.Entity("linksy_backend_api.Domain.Entities.Models.FriendInvite", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("friend_invites_pkey");

                    b.HasIndex("Token")
                        .IsUnique()
                        .HasDatabaseName("friend_invites_token_uidx");

                    b.HasIndex("InviterId", "IsUsed", "ExpiresAt")
            ...
            modelBuilder.Entity("linksy_backend_api.Domain.Entities.Models.ScheduledMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("scheduled_messages_pkey");
                    ...
                    b.HasIndex("ChatroomId", "SenderId", "Status", "SendAt")
            ...
            modelBuilder.Entity("linksy_backend_api.Domain.Entities.Models.UserReport", b =>
                {
                    ...
                    b.HasIndex(new[] { "ReportedUserId", "Status" }, "user_reports_reported_user_id_status_idx");

                    b.HasIndex(new[] { "ReporterUserId", "ReportedUserId", "Status" }, "user_reports_reporter_reported_pending_idx")
                        .IsUnique()
                        .HasFilter("status = 'pending'");

                    b.HasIndex(new[] { "ReporterUserId", "CreatedAt" }, "user_reports_reporter_user_id_created_at_idx");

                    b.HasIndex(new[] { "Status", "CreatedAt" }, "user_reports_status_created_at_idx");

                    b.ToTable("user_reports", null, t =>
                        {
                            t.HasComment("CHECK (reporter_user_id != reported_user_id)");
                        });
                });
            ...
            modelBuilder.Entity("linksy_backend_api.Models.User", b =>
                {
                    ...
                    b.Property<string>("ModerationLevel")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(30)
                    ...
                    b.HasIndex(new[] { "IsFlaggedForReview" }, "users_is_flagged_for_review_idx");

                    b.HasIndex(new[] { "LastLoginAt" }, "users_last_login_at_idx");

                    b.HasIndex(new[] { "ModerationLevel" }, "users_moderation_level_idx");
            ...
            modelBuilder.Entity("linksy_backend_api.Domain.Entities.Models.FriendInvite", b =>
                {
                    b.HasOne("linksy_backend_api.Models.User", "Inviter")
                        .WithMany()
            ...
            modelBuilder.Entity("linksy_backend_api.Domain.Entities.Models.UserReport", b =>
                {
                    ...
                    b.HasOne("linksy_backend_api.Models.User", "ReporterUser")
                    ...
                    b.HasOne("linksy_backend_api.Models.User", "ReviewedByAdmin")
                        .WithMany()
            ...
            modelBuilder.Entity("linksy_backend_api.Models.User", b =>
                {
                    b.HasOne("linksy_backend_api.Models.User", "ModeratedByAdmin")
                        .WithMany()
